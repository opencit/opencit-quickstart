...
# cit requires java 1.8 or later
...
echo "export JAVA_CMD=$JAVA_CMD" >> $CIT_ENV/cit-java
...
#attestationhub-0.1-SNAPSHOT.bin -> cit3-attestationhub.bin
ATTESTATION_HUB_BIN=`ls -1 attestation-hub-*.bin | head -n 1`
